        ...
        <>
            ...
            <nav className="my-6">
                <ReactPaginate
                    ...
                    pageClassName="group"
                    pageLinkClassName="p-3 text-conduit-green border border-conduit-gray-300 -ml-px group-[&:nth-child(2)]:rounded-l group-[&:nth-last-child(2)]:rounded-r hover:bg-conduit-gray-200"
